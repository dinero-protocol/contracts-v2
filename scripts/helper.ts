const getBlockTimestamp = async (provider: any, block: number) => {
...
export const getDeadlineMetadata = async (
  ...
  const curDeadline = firstCurDeadline + (epoch - 1) * 1209600;
  ...
  const minDeadline = firstMinDeadline + (epoch - 1) * 1209600;
  ...
  const maxDeadline = firstMaxDeadline + (epoch - 1) * 1209600;
  ...
  const prevDeadline = firstCurDeadline + (epoch - 2) * 1209600;
